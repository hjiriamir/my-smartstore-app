...
const SceneCapture = ({ onCapture }) => {
  ...
  useEffect(() => {
    ...
    const timeoutId = setTimeout(() => {
      // Assurer que le rendu est à jour
...
const PlanogramScene = ({
  ...
  useEffect(() => {
    scene.background = new THREE.Color("#f0f8ff") // Lighter blue background
  }, [scene])
...
export function PlanogramEditor() {
  ...
  const savePlanogramToLibrary = (name: string, description: string, furnitureProducts) => {
    // Create furniture item from planogram config
    const furnitureToSave = {
      id: `${planogramConfig.furnitureType}-${Date.now()}`,
      type: planogramConfig.furnitureType, // Conserver le type de meuble actuel
      name,
    ...
    console.log(`Saving ${planogramConfig.furnitureType} to library with ${furnitureProducts.length} products`)
                                ...
                                <div className="space-y-2">
                                  ...
                                  >
                                    <Button
                                      ...
                                      disabled={planogramConfig.shelvesConfig?.frontBackColumns <= 1}
                                    >
                                      <Minus className="h-4 w-4" />
                                    </Button>
                                    <Input
                                ...
                                <div className="space-y-2">
                                  ...
                                  >
                                    <Button
                                      ...
                                      disabled={planogramConfig.shelvesConfig?.leftRightColumns <= 1}
                                    >
                                      <Minus className="h-4 w-4" />
                                    </Button>
                                    <Input
                      ...
                      {viewMode === "2D" ? (
                        <div className="overflow-auto border rounded-md p-4 bg-muted/20">
                          ...
                          >
                            ...
                            {/* Indicateur de séparation pour la gondole en mode 2D */}
                        ...
                        <div
                          ...
                          style={{ height: "600px" }}
                        >
                          <Canvas shadows key={`3d-canvas-${forceRender}`}>
                            <PlanogramScene
                              planogramConfig={planogramConfig}
                              cells={cells}
                              products={products}
